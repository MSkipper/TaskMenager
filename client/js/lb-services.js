  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Group.tasks.findById() instead.
        "prototype$__findById__tasks": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Groups/:id/tasks/:fk",
          method: "GET"
        },

        // INTERNAL. Use Group.tasks.destroyById() instead.
        ...
        // INTERNAL. Use Group.tasks.updateById() instead.
        ...
        // INTERNAL. Use Group.libs.findById() instead.
        "prototype$__findById__libs": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Groups/:id/libs/:fk",
          method: "GET"
        },

        // INTERNAL. Use Group.libs.destroyById() instead.
        "prototype$__destroyById__libs": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Groups/:id/libs/:fk",
        ...
        // INTERNAL. Use Group.libs.updateById() instead.
        "prototype$__updateById__libs": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Groups/:id/libs/:fk",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__findById__accounts
        ...
        "prototype$__findById__accounts": {
          ...
          url: urlBase + "/Groups/:id/accounts/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__destroyById__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__updateById__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__link__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        "prototype$__link__accounts": {
          ...
          url: urlBase + "/Groups/:id/accounts/rel/:fk",
          method: "PUT"
        },

        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__unlink__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__exists__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        // INTERNAL. Use Group.tasks() instead.
        "prototype$__get__tasks": {
          isArray: true,
          url: urlBase + "/Groups/:id/tasks",
          method: "GET"
        },

        // INTERNAL. Use Group.tasks.create() instead.
        "prototype$__create__tasks": {
          url: urlBase + "/Groups/:id/tasks",
          method: "POST"
        },

        // INTERNAL. Use Group.tasks.destroyAll() instead.
        "prototype$__delete__tasks": {
          url: urlBase + "/Groups/:id/tasks",
          method: "DELETE"
        },

        // INTERNAL. Use Group.tasks.count() instead.
        "prototype$__count__tasks": {
          url: urlBase + "/Groups/:id/tasks/count",
          method: "GET"
        },

        // INTERNAL. Use Group.libs() instead.
        "prototype$__get__libs": {
          isArray: true,
          url: urlBase + "/Groups/:id/libs",
          method: "GET"
        },

        // INTERNAL. Use Group.libs.create() instead.
        "prototype$__create__libs": {
          url: urlBase + "/Groups/:id/libs",
          method: "POST"
        },

        // INTERNAL. Use Group.libs.destroyAll() instead.
        "prototype$__delete__libs": {
          url: urlBase + "/Groups/:id/libs",
          method: "DELETE"
        },

        // INTERNAL. Use Group.libs.count() instead.
        "prototype$__count__libs": {
          url: urlBase + "/Groups/:id/libs/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__get__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
         * Queries accounts of Group.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        "prototype$__get__accounts": {
          isArray: true,
          url: urlBase + "/Groups/:id/accounts",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__create__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__delete__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#prototype$__count__accounts
         * @methodOf lbServices.Group
         *
         * @description
         *
         * Counts accounts of Group.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        "prototype$__count__accounts": {
          url: urlBase + "/Groups/:id/accounts/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use GroupHasAcc.groups() instead.
        "::get::groupHasAcc::groups": {
          url: urlBase + "/groupHasAccs/:id/groups",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Group.tasks
     * @header lbServices.Group.tasks
     * @object
     * @description
     *
     * The object `Group.tasks` groups methods
     * manipulating `Task` instances related to `Group`.
     *
     * Call {@link lbServices.Group#tasks Group.tasks()}
     ...
     */
        ...
        R.tasks = function() {
          ...
          var action = TargetResource["::get::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#count
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
         * Counts tasks of Group.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.tasks.count = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::count::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#create
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
        ...
        R.tasks.create = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::create::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#createMany
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
        ...
        R.tasks.createMany = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::createMany::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#destroyAll
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
        ...
        R.tasks.destroyAll = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::delete::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#destroyById
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
        ...
        R.tasks.destroyById = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::destroyById::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#findById
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
        ...
        R.tasks.findById = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::findById::Group::tasks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.tasks#updateById
         * @methodOf lbServices.Group.tasks
         *
         * @description
         *
        ...
        R.tasks.updateById = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::updateById::Group::tasks"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Group.libs
     * @header lbServices.Group.libs
     * @object
     * @description
     *
     * The object `Group.libs` groups methods
     * manipulating `Lib` instances related to `Group`.
     *
     * Call {@link lbServices.Group#libs Group.libs()}
     * to query all related instances.
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Lib` object.)
         * </em>
         */
        R.libs = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::get::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#count
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         * Counts libs of Group.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.libs.count = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::count::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#create
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         * Creates a new instance in libs of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.libs.create = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::create::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#createMany
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         ...
         * </em>
         */
        R.libs.createMany = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::createMany::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#destroyAll
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         * Deletes all libs of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.libs.destroyAll = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::delete::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#destroyById
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         * Delete a related item by id for libs.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for libs
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.libs.destroyById = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::destroyById::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#findById
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         * Find a related item by id for libs.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.libs.findById = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::findById::Group::libs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.libs#updateById
         * @methodOf lbServices.Group.libs
         *
         * @description
         *
         * Update a related item by id for libs.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.libs.updateById = function() {
          var TargetResource = $injector.get("Lib");
          var action = TargetResource["::updateById::Group::libs"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Group.tasks.createMany() instead.
        "::createMany::Group::tasks": {
          isArray: true,
          url: urlBase + "/Groups/:id/tasks",
          method: "POST"
        },
 ...
 * @ngdoc object
 * @name lbServices.Lib
 * @header lbServices.Lib
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Lib` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lib#create
         * @methodOf lbServices.Lib
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lib#createMany
         * @methodOf lbServices.Lib
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Libs/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Lib#findById
         * @methodOf lbServices.Lib
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Libs/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Lib#updateAll
         * @methodOf lbServices.Lib
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Libs/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Lib#deleteById
         * @methodOf lbServices.Lib
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Libs/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Lib#prototype$updateAttributes
         * @methodOf lbServices.Lib
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lib#createChangeStream
         * @methodOf lbServices.Lib
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Libs/change-stream",
          method: "POST"
        },
        ...
        // INTERNAL. Use Group.libs.createMany() instead.
        "::createMany::Group::libs": {
          isArray: true,
          url: urlBase + "/Groups/:id/libs",
          method: "POST"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lib#updateOrCreate
         * @methodOf lbServices.Lib
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lib#destroyById
         * @methodOf lbServices.Lib
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lib#removeById
         * @methodOf lbServices.Lib
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Lib#modelName
    * @propertyOf lbServices.Lib
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Lib`.
    */
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__findById__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__findById__RoleMappings": {
          ...
          url: urlBase + "/Accounts/:id/RoleMappings/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__destroyById__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__updateById__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__findById__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__findById__Roles": {
          ...
          url: urlBase + "/Accounts/:id/Roles/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__destroyById__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__updateById__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__link__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__link__Roles": {
          ...
          url: urlBase + "/Accounts/:id/Roles/rel/:fk",
          method: "PUT"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__unlink__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__exists__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__findById__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__findById__groups": {
          ...
          url: urlBase + "/Accounts/:id/groups/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__destroyById__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__updateById__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__link__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__link__groups": {
          ...
          url: urlBase + "/Accounts/:id/groups/rel/:fk",
          method: "PUT"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__unlink__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__exists__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__get__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
         * Queries RoleMappings of Account.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__RoleMappings": {
          isArray: true,
          url: urlBase + "/Accounts/:id/RoleMappings",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__create__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__delete__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__count__RoleMappings
         * @methodOf lbServices.Account
         *
         * @description
         *
         * Counts RoleMappings of Account.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__count__RoleMappings": {
          url: urlBase + "/Accounts/:id/RoleMappings/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__get__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__get__Roles": {
          isArray: true,
          url: urlBase + "/Accounts/:id/Roles",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__create__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__delete__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__count__Roles
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        "prototype$__count__Roles": {
          url: urlBase + "/Accounts/:id/Roles/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__get__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
         * Queries groups of Account.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__groups": {
          isArray: true,
          url: urlBase + "/Accounts/:id/groups",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__create__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__delete__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#prototype$__count__groups
         * @methodOf lbServices.Account
         *
         * @description
         *
         * Counts groups of Account.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__count__groups": {
          url: urlBase + "/Accounts/:id/groups/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use GroupHasAcc.accounts() instead.
        "::get::groupHasAcc::accounts": {
          url: urlBase + "/groupHasAccs/:id/accounts",
          method: "GET"
        },
...
/**
 * @ngdoc object
 * @name lbServices.GroupHasAcc
 * @header lbServices.GroupHasAcc
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `GroupHasAcc` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#create
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `GroupHasAcc` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/groupHasAccs",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#createMany
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#upsert
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#exists
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/groupHasAccs/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#findById
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/groupHasAccs/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#find
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#findOne
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/groupHasAccs/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#updateAll
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/groupHasAccs/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#deleteById
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#count
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/groupHasAccs/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#prototype$updateAttributes
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#createChangeStream
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/groupHasAccs/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#updateOrCreate
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#update
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#destroyById
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#removeById
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.GroupHasAcc#modelName
    * @propertyOf lbServices.GroupHasAcc
    * @description
    * The name of the model represented by this $resource,
    * i.e. `GroupHasAcc`.
    */
    R.modelName = "GroupHasAcc";


        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#groups
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        R.groups = function() {
          ...
          var action = TargetResource["::get::groupHasAcc::groups"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GroupHasAcc#accounts
         * @methodOf lbServices.GroupHasAcc
         *
         * @description
         *
        ...
        R.accounts = function() {
          var TargetResource = $injector.get("Account");
          var action = TargetResource["::get::groupHasAcc::accounts"];
          return action.apply(R, arguments);
        };
